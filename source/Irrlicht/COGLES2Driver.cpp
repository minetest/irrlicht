		...
		GLenum &pixelType, void (**converter)(const void *, s32, void *)) const
{
	...
	*converter = 0;
	...
	case ECF_R16F:
		...
		if (queryGLESFeature(COGLESCoreExtensionHandler::IRR_GL_EXT_texture_rg) && queryGLESFeature(COGLESCoreExtensionHandler::IRR_GL_OES_texture_half_float)) {
			supported = true;
			pixelFormat = GL_RED_EXT;
	...
	case ECF_R32F:
		...
		if (queryGLESFeature(COGLESCoreExtensionHandler::IRR_GL_EXT_texture_rg) && queryGLESFeature(COGLESCoreExtensionHandler::IRR_GL_OES_texture_float)) {
			supported = true;
			pixelFormat = GL_RED_EXT;
			pixelType = GL_FLOAT;
		}
